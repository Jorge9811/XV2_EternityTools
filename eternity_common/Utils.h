...
namespace Utils
{
    ...
    inline bool CompareFloat(float f1, float f2, float epsilon=0.0001) { return fabs(f1 - f2) < epsilon; }
    ...
    size_t GetMultipleStrings(const std::string &str, std::vector<std::string> &list, char separator = ',', bool omit_empty_strings=true);
