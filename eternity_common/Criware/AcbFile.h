...
public:
    ...
    virtual size_t TrackIndexToCueIndexes(uint32_t idx, std::vector<uint32_t> &cue_idxs) const;
    ...
    //
    bool GetTrackCommandIndex(uint32_t cue_idx, uint16_t *cmd_idx) const;
    bool GetSequenceCommandIndex(uint32_t cue_idx, uint16_t *cmd_idx) const;
