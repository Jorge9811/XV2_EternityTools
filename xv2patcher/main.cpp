...
PUBLIC int Function73(int arg0)
{
	...
	if (u73)
	{	
		if (arg0 == 0x16 || arg0 == 0x17 || arg0 == 0x1E || arg0 == 0x1F || arg0 == 0x23 || arg0 == 0x24)
			return 1;
	}
...
PUBLIC int Function138(int arg0)
{
	...
	if (u73)
	{	
		if (arg0 == 0x15 || arg0 == 0x16 || arg0 == 0x1A || arg0 == 0x1B)
			return 1;
	}
...
{
	std::u16string version = version_string;	
	...
	version = u"<font size=\"10\">v" + version.substr(4) + u" (patcher " XV2_PATCHER_VERSION ")</font>";	
