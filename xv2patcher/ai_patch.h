...
struct AICharacter
{
	...
	AICharacter(Battle_Mob *mob, bool is_enemy) : mob(mob), is_enemy(is_enemy)
	{
		...
		if (test_144 && base_trans_control == 0x36 && num_transforms == 4)
		{
			num_transforms = 3;			
		}
		else if (test_144 && base_trans_control == 0x3F && num_transforms == 2)
		{
			num_transforms = 1;
		}
		else if (test_144 && base_trans_control == 0x39 && num_transforms == 4)
		{
			num_transforms = 3;
		}
